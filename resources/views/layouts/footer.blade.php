<footer class="mx-auto bg-black rounded-t-2xl py-10">
    <div class="max-w-7xl mx-auto py-10">
        <div class="flex justify-around items-center pb-10">
            <h2 class="text-white font-semibold text-5xl font-mulish">Месечен <br> билтен</h2>
            <p class="text-gray-200 max-w-[243px]">Lorem ipsum dolor sit amet consectetur. Non at at risus dolor
        ...
        <div class="max-w-7xl mx-auto pt-10 px-5">
            <div class="flex justify-around items-baseline pb-10">
                <div>
                    <h3 class="text-white text-2xl mb-7 font-mulish">Контактирај не!</h3>
                ...
                <div>
                    ...
                    <p class="text-gray-200 max-w-[243px]">Lorem ipsum dolor sit amet consectetur. Non at at risus
